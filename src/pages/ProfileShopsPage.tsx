/**
 * Profile Shops Page - Trang quản lý shop với layout đầy đủ
 */
...
export default function ProfileShopsPage() {
  ...
  // Not authenticated - redirect to login (chỉ khi đã check xong)
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              <img src="/logo_betacom.png" alt="BETACOM" className="w-10 h-10 rounded-lg object-contain" />
              <div>
